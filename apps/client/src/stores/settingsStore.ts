...
interface SettingsState {
  ...
  setPlaylistSort: (by: PlaylistSortBy, direction: PlaylistSortDirection) => Promise<void>;
}
...
const PLAYLIST_SORT_DIRECTION_STORAGE_KEY = "resonia:settings:playlistSortDirection";
...
export const useSettingsStore = create<SettingsState>((set) => ({
  ...
  hydrate: async () => {
    const [stored, lastfmApiKey, animatedArtworkBaseUrl, cacheMaxBytes, playlistSortBy, playlistSortDirection] = await Promise.all([
